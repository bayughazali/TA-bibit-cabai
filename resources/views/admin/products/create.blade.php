        ...
        <header class="topbar">
            <div class="topbar-left">
                ...
                <div class="topbar-title">
                    ...
                    <p>Tambah produk bibit baru ke dalam sistem</p>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data" id="productForm">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      placeholder="Jelaskan keunggulan dan cara perawatan bibit...">{{ old('description') }}</textarea>
                        ...
                        <div class="info-banner">
                            ...
                            <div>Pastikan semua data sudah benar sebelum menyimpan. Produk akan langsung tampil di website setelah disimpan.</div>
                        </div>
